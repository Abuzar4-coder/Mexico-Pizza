const CACHE_NAME = 'mp-kitchen-v1';
self.addEventListener('install', e => { e.waitUntil(caches.open(CACHE_NAME).then(c => c.addAll(['./kitchen.html','./manifest-kitchen.json'])).catch(()=>{})); self.skipWaiting(); });
